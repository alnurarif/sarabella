...
import View_sub_categories_content from '../../../layouts/manage/sub_categories/View_sub_categories_content'
class View_sub_categories extends Component{
	render(){
		return (
			<>
				<Head />
...
export default View_sub_categories