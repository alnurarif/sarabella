...
import Order_confirmed_content from '../layouts/Order_confirmed_content'
...
class Order_confirmed extends Component{
	state = {
		categories : [],
		sub_categories : [],
		sections : []
	...
	render(){
		return (
			<div>
				...
				<Order_confirmed_content allState={this.state} methods={this.methods} />
