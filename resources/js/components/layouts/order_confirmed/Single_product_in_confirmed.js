...
class Single_product_in_confirmed extends Component{
	constructor(props){
		super(props)
	}
	methods = {
	...
	render(){
		...
		return (
			<div className="fix full div_mid pt_20 pb_20">
				...
				<div className="fix floatleft half bg_ash border_box pt_10 pr_10 pb_10 pl_10">
					<div className="fix full cart_table">
						...
						<div className="fix full cart_header bg_white">
							...
							<div className="fix floatleft one_by_ten pt_5 pr_5 pb_5 pl_5 border_box">
								<p className="text_dark_ash fs_13 lh_18 textcenter">{this.props.product_info.product_quantity}</p>
							</div>
					...
					<div className="fix full mt_30">
						<div className="fix floatleft half pt_10 pb_10 pr_5 pl_5 border_box">
							...
							<p className="text_dark_ash fs_13 lh_18">{this.props.product_info.room_name}</p>
						</div>
						<div className="fix floatleft half pt_10 pb_10 pr_5 pl_5 border_box">
							<p className="fs_14 lh_22 text_dark_ash font_bold">NOTES</p>
							<p className="text_dark_ash fs_13 lh_18">{this.props.product_info.notes}</p>
						</div>
					</div>
...
export default Single_product_in_confirmed
